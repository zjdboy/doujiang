...
<?php $__TAG__ = '{"num":"1","type":"all","order":"desc","by":"time","level":"4","key":"notice","id":"vo"}';$__LIST__ = model("Art")->listCacheData($__TAG__); if(is_array($__LIST__['list']) || $__LIST__['list'] instanceof \think\Collection || $__LIST__['list'] instanceof \think\Paginator): $notice = 0; $__LIST__ = $__LIST__['list'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($notice % 2 );++$notice;?>
...
<div class="fed-part-layout fed-back-whits">
	<div class="fed-list-head fed-part-rows fed-padding">
		<h2 class="fed-font-xvi">最新影讯</h2>
		<ul class="fed-part-tips fed-padding">
			<li<?php if($maccms['aid']!=10): ?> class="fed-more"<?php endif; ?>>今日更新&nbsp;<span class="fed-text-green"><?php echo mac_data_count(0,'today','art'); ?></span>&nbsp;篇&nbsp;&nbsp;共&nbsp;<span class="fed-text-green"><?php echo mac_data_count(0,'all','art'); ?>&nbsp;</span>篇</li>
			<?php if($maccms['aid']==1): ?>
	...
	<ul class="fed-list-info fed-list-img fed-part-rows">
		<?php $__TAG__ = '{"num":"4","type":"current","order":"desc","by":"time","id":"vo","key":"key"}';$__LIST__ = model("Art")->listCacheData($__TAG__); if(is_array($__LIST__['list']) || $__LIST__['list'] instanceof \think\Collection || $__LIST__['list'] instanceof \think\Paginator): $key = 0; $__LIST__ = $__LIST__['list'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($key % 2 );++$key;?>
		...
		<a class="fed-list-pics fed-lazy fed-part-16by9" href="<?php echo mac_url_art_detail($vo); ?>" data-original="http://static.yg.cn/<?php echo mac_url_img($vo['art_pic']); ?>">
<span class="fed-list-score fed-font-xii fed-back-green"><?php echo $vo['type']['type_name']; ?></span>
</a>
<a class="fed-list-title fed-font-xiv fed-text-center fed-text-sm-left fed-visible fed-part-eone" href="<?php echo mac_url_art_detail($vo); ?>"><?php echo $vo['art_name']; ?></a>

		</li>
		<?php endforeach; endif; else: echo "" ;endif; ?>
	</ul>
</div>
<?php endif; $__TAG__ = '{"num":"6","ids":"parent","order":"asc","by":"sort","flag":"vod","id":"vfed","key":"key"}';$__LIST__ = model("Type")->listCacheData($__TAG__); if(is_array($__LIST__['list']) || $__LIST__['list'] instanceof \think\Collection || $__LIST__['list'] instanceof \think\Paginator): $key = 0; $__LIST__ = $__LIST__['list'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vfed): $mod = ($key % 2 );++$key;?>
<div class="fed-list-home fed-part-layout fed-back-whits fed-part-rows">
	<div class="fed-list-head fed-part-rows fed-padding">
		<h2 class="fed-font-xvi"><?php echo $vfed['type_name']; ?></h2>
		<ul class="fed-part-tips fed-padding">
			<?php $__TAG__ = '{"num":"7","parent":"'.$vfed['type_id'].'","order":"asc","by":"sort","mid":"vod","id":"vo","key":"key"}';$__LIST__ = model("Type")->listCacheData($__TAG__); if(is_array($__LIST__['list']) || $__LIST__['list'] instanceof \think\Collection || $__LIST__['list'] instanceof \think\Paginator): $key = 0; $__LIST__ = $__LIST__['list'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($key % 2 );++$key;?>
	...
	<div class="fed-part-rows">
		<?php if($vfed['type_name']!='直播'): ?>
		<ul class="fed-list-info fed-part-rows">
			<?php $__TAG__ = '{"num":"12","type":"'.$vfed['type_id'].'","order":"desc","by":"time","id":"vo","key":"key"}';$__LIST__ = model("Vod")->listCacheData($__TAG__); if(is_array($__LIST__['list']) || $__LIST__['list'] instanceof \think\Collection || $__LIST__['list'] instanceof \think\Paginator): $key = 0; $__LIST__ = $__LIST__['list'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($key % 2 );++$key;?>
			<li class="fed-list-item fed-padding fed-col-xs4 fed-col-sm3 fed-col-md2<?php if($key>6): ?> fed-hide-xs<?php endif; ?>">
			<a class="fed-list-pics fed-lazy fed-part-2by3" href="<?php echo mac_url_vod_detail($vo); ?>" data-original="http://static.yg.cn/<?php echo mac_url_img($vo['vod_pic']); ?>">
<span class="fed-list-play fed-hide-xs"></span>
<?php if($vo['vod_score']>0): ?>
<span class="fed-list-score fed-font-xii fed-back-green"><?php echo $vo['vod_score']; ?></span>
...
<?php echo mac_default($vo['vod_actor'],'内详'); ?>
		...
		<ul class="fed-list-info fed-list-img fed-part-rows">
			...
			<li class="fed-list-item fed-padding fed-col-xs6 fed-col-sm4 fed-col-md3<?php if($key>6): ?> fed-hide fed-show-md-block<?php endif; ?>">
...
<span class="fed-list-remarks fed-font-xii fed-text-white fed-text-center"><?php echo $vo['vod_name']; ?></span>
	...
	<?php if($vfed['type_name']=='直播'): ?>
	<ul class="fed-list-text fed-part-rows fed-part-both fed-hide-xs fed-show-sm-block">
		<?php $__TAG__ = '{"num":"12","type":"'.$vfed['type_id'].'","order":"desc","by":"time","start":"7","id":"vo","key":"key"}';$__LIST__ = model("Vod")->listCacheData($__TAG__); if(is_array($__LIST__['list']) || $__LIST__['list'] instanceof \think\Collection || $__LIST__['list'] instanceof \think\Paginator): $key = 0; $__LIST__ = $__LIST__['list'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($key % 2 );++$key;?>
		<li class="fed-list-item fed-col-xs4 fed-col-sm3 fed-col-md2">
<a class="fed-list-title fed-text-line fed-visible fed-part-eone" href="<?php echo mac_url_vod_detail($vo); ?>"><?php echo $vo['vod_name']; ?><i class="fed-icon-font fed-icon-you"></i></a>
</li>
		<?php endforeach; endif; else: echo "" ;endif; ?>
...
<div class="fed-topi-info fed-part-layout fed-back-whits fed-part-rows">
	<div class="fed-list-head fed-part-rows fed-padding">
		<h2 class="fed-font-xvi">专题</h2>
		<ul class="fed-part-tips fed-padding">
			<li><a class="fed-more" href="<?php echo mac_url_topic_index(); ?>">更多</a></li>
		</ul>
	</div>
	<ul class="fed-list-info fed-part-rows">
		<?php $__TAG__ = '{"num":"3","order":"desc","by":"time","id":"vo","key":"key"}';$__LIST__ = model("Topic")->listCacheData($__TAG__); if(is_array($__LIST__['list']) || $__LIST__['list'] instanceof \think\Collection || $__LIST__['list'] instanceof \think\Paginator): $key = 0; $__LIST__ = $__LIST__['list'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($key % 2 );++$key;?>
		<li class="fed-list-item fed-padding fed-col-xs12 fed-col-sm6 fed-col-md4<?php if($key>2): ?> fed-hide-sm fed-show-md-block<?php endif; ?>">
		<a class="fed-list-pics fed-lazy fed-part-2by1" href="<?php echo mac_url_topic_detail($vo); ?>" data-original="http://static.yg.cn/<?php echo mac_url_img($vo['topic_pic']); ?>">
			<div class="fed-topi-back">
				...
				<span class="fed-list-name fed-visible fed-font-xvi fed-text-white fed-text-center">—— <?php echo count(explode(',',$vo['topic_rel_vod'])); ?>个影片 ——</span>
...
<?php endforeach; endif; else: echo "" ;endif; $__TAG__ = '{"num":"1","type":"font","id":"vo","key":"key"}';$__LIST__ = model("Link")->listCacheData($__TAG__); if(is_array($__LIST__['list']) || $__LIST__['list'] instanceof \think\Collection || $__LIST__['list'] instanceof \think\Paginator): $key = 0; $__LIST__ = $__LIST__['list'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($key % 2 );++$key;?>
<div class="fed-part-layout fed-back-whits">
	<div class="fed-list-head fed-part-rows fed-padding">
		<h2 class="fed-font-xvi">友情链接</h2>
		<?php $vfedcc = require ('application/extra/maccms.php'); if($vfedcc['gbook']['status']=='1') { ?>
		<ul class="fed-part-tips fed-padding">
	...
	<ul class="fed-part-rows">
		...
		<li class="fed-width-x fed-padding fed-col-xs4 fed-col-sm3 fed-col-md2">
