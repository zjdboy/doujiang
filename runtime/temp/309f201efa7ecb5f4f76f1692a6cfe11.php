<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:62:"/usr/local/var/www/yg/application/admin/view/timming/info.html";i:1563008642;s:61:"/usr/local/var/www/yg/application/admin/view/public/head.html";i:1522628860;s:61:"/usr/local/var/www/yg/application/admin/view/public/foot.html";i:1526021730;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
                    ...
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-inline w500">
                            <select class="" name="file">
                                <option value="updatevod" <?php if($info['file'] == 'updatevod'): ?>selected<?php endif; ?>>更新updatevod</option>
