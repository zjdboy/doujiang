...
<div class="fed-head-info fed-back-whits fed-min-width fed-box-shadow">
	<div class="fed-part-case">
		<div class="fed-navs-left">
			<a class="fed-navs-logo" href="<?php echo $maccms['path']; ?>"><img style="width:120px; height:41px;" alt="<?php echo $maccms['site_name']; ?>" src="<?php echo $maccms['path_tpl']; ?>asset/img/logo_golden.png" ></a>
...
<?php if($obj['childids']): if((mac_data_count(0,'all','art'))!=''): ?>
	...
	<div class="fed-main-left fed-col-xs12 fed-col-md9">
		...
		<div class="fed-part-layout fed-back-whits fed-margin-right">
			<div class="fed-list-head fed-part-rows fed-padding">
				...
				<ul class="fed-part-tips fed-padding">
					<li><a class="fed-more" href="<?php echo mac_url_type($obj['parent']); ?>"></a></li>
				</ul>
			</div>
			<?php $__TAG__ = '{"num":"6","paging":"yes","half":"3","type":"current","order":"desc","by":"time","id":"vo","key":"key"}';$__LIST__ = model("Art")->listCacheData($__TAG__);$__PAGING__ = mac_page_param($__LIST__['total'],$__LIST__['limit'],$__LIST__['page'],$__LIST__['pageurl'],$__LIST__['half']); if(is_array($__LIST__['list']) || $__LIST__['list'] instanceof \think\Collection || $__LIST__['list'] instanceof \think\Paginator): $key = 0; $__LIST__ = $__LIST__['list'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($key % 2 );++$key;?>
			<dl class="fed-list-arti fed-list-deta fed-deta-padding fed-line-top fed-margin fed-part-rows fed-part-over">
	<dt class="fed-deta-images fed-list-info fed-col-xs3">
		<a class="fed-list-pics fed-lazy fed-part-16by9" href="<?php echo mac_url_art_detail($vo); ?>" data-original="http://static.yg.cn/<?php echo mac_url_img($vo['art_pic']); ?>"></a>
	</dt>
	<dd class="fed-deta-content fed-col-xs7 fed-col-sm8">
		<h3 class=""><a class="fed-part-etwo fed-visible" href="<?php echo mac_url_art_detail($vo); ?>"><?php echo $vo['art_name']; ?></a></h3>
		<p class="fed-hide-xs fed-text-muted"><?php echo mac_substring(mac_filter_html($vo['art_content']),60); ?></p>
		<span class="fed-visible fed-text-muted"><?php echo mac_friend_date($vo['art_time']); ?>　<?php echo $vo['art_hits']; ?> views</span>
	</dd>
</dl>
