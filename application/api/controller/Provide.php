...
class Provide extends Base
{
    ...
    public function vod()
    {
        ...
        if (empty($html) || $cache_time==0) {
            ...
            $data = model('vod')->listData($where, $order, $this->_param['pg'], $GLOBALS['config']['api']['vod']['pagesize'], 0, $field, 0);
    ...
    public function art()
    {
        ...
        if (empty($html) || $cache_time==0) {
            ...
            $data = model('art')->listData($where, $order, $this->_param['pg'], $GLOBALS['config']['api']['art']['pagesize'], 0, $field, 0);
