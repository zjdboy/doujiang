...
class Template extends Base
{
    ...
    public function ad()
    {
        ...
        $this->assign('title','广告位管理');
        return $this->fetch('admin@template/ad');
    }

    public function ver()
    {
        $res = model('Ver')->listData($where,$order,$param['page'],$param['limit']);
        ...
        return $this->fetch('admin@template/ver');
    }
    ...
    public function adinfo()
    {
        ...
        return $this->fetch('admin@template/adinfo');
    }
    ...
    public function verinfo()
    {
        ...
        if (Request()->isPost()) {
            $param['uptime'] = date("Y-m-d H:i:s",time());
            $res = model('Ver')->saveData($param);
            return $this->success('保存成功');
        }

        return $this->fetch('admin@template/verinfo');
    }
